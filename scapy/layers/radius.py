...
class RadiusAttribute(Packet):
    ...
    def haslayer(self, cls):
        if cls == RadiusAttribute:
            for attr_class in list(RadiusAttribute.registered_attributes.values()):
                if isinstance(self, attr_class):
                    return True
        elif cls in list(RadiusAttribute.registered_attributes.values()) and isinstance(self, cls):
            return True
        return False
