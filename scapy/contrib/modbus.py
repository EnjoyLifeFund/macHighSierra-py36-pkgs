...
class ModbusADURequest(Packet):
    ...
    def guess_payload_class(self, payload):
        ...
        try:
            ...
            pass
        if function_code in list(_reserved_funccode_request.keys()):
...
class ModbusADUResponse(Packet):
    ...
    def guess_payload_class(self, payload):
        ...
        try:
            ...
            pass
        if function_code in list(_reserved_funccode_response.keys()):
            return ModbusPDUReservedFunctionCodeResponse
        elif function_code in list(_reserved_funccode_error.keys()):
